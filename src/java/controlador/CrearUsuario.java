...
@WebServlet(name = "CrearUsuario", urlPatterns = {"/createuser"})
public class CrearUsuario extends HttpServlet {
    ...
    if ("crear_cliente".equals(action)) {
        if (tipoDocumento == null || tipoDocumento.trim().isEmpty() ||
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Error en la Creación del Usuario</title>");
                out.println("</head>");
                out.println("<body>");
            ...
            // Si todos los campos están completos, se crea el usuario
            response.setContentType("text/html;charset=UTF-8");
            try (PrintWriter out = response.getWriter()) {
                out.println("<!DOCTYPE html>");
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Usuario Creado</title>");
                out.println("</head>");
                out.println("<body>");
                out.println("<h1>Usuario creado exitosamente</h1>");
                out.println("</body>");
                out.println("</html>");
            }
        }
